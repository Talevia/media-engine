...
/* Pull parse helpers + LoadError from the extracted TU so existing
 * call sites below stay unqualified. See
 * `src/timeline/loader_helpers.hpp` for their contracts. */
