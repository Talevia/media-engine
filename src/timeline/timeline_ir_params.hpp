...
#include "timeline/effect_params/displacement.hpp"
...
#include "timeline/effect_params/tilt_shift.hpp"
...
struct EffectSpec {
     ...
     * RadialBlur → 18, TiltShift → 19, Warp → 20,
     * Displacement → 21) so consumers can
