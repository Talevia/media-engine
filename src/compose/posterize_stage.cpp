...
me_status_t posterize_kernel(task::TaskContext&,
    ...
    const me_status_t s = apply_posterize_inplace(
...
void register_posterize_kind() {
    task::KindInfo info{
        .kind           = task::TaskKindId::RenderPosterize,
        .affinity       = task::Affinity::Cpu,
        .latency        = task::Latency::Short,
        .time_invariant = true,
        .kernel         = posterize_kernel,
        .input_schema   = {
