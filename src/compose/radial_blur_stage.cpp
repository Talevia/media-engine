...
me_status_t radial_blur_kernel(task::TaskContext&,
    ...
    const me_status_t s = apply_radial_blur_inplace(
...
void register_radial_blur_kind() {
    task::KindInfo info{
        .kind           = task::TaskKindId::RenderRadialBlur,
        .affinity       = task::Affinity::Cpu,
        .latency        = task::Latency::Short,
        .time_invariant = true,
        .kernel         = radial_blur_kernel,
        .input_schema   = {
