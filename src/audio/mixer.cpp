...
/* build_audio_mixer_for_timeline lives in mixer_builder.cpp — the
 * Timeline-walking factory split out to keep this TU focused on the
 * per-frame mix pipeline. The function's public declaration stays in
 * mixer.hpp; callers are unchanged. */
