/*
 * 05_reencode — timeline + h264/AAC spec → transcoded MP4.
 *
 * Same C API shape as 01_passthrough, but sets
 *   video_codec = "h264"   → h264_videotoolbox (macOS HW encoder)
 *   audio_codec = "aac"    → libavcodec built-in AAC
 *
 * Usage: 05_reencode <timeline.json> <output.mp4>
 */
